...
class CNN(nn.Module):
    def __init__(self, channel=1, num_classes=10, net_width=128, net_depth=3, net_act='relu', net_norm='instancenorm', net_pooling='avgpooling', im_size = (32,32)):
...
class MLP(nn.Module):
    ...
    def __init__(self, img_dim=(1,28,28), num_classes=10):
        ...
        self.fc_1 = nn.Linear(np.prod(img_dim), 128)
